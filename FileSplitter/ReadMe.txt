================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: FileSplitter プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した FileSplitter には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには FileSplitter アプリケーションを構成している各ファイ
ルの概要説明が含まれます。
...
FileSplitter.h
   ...
   CFileSplitterApp アプリケーション クラスを宣言します。

FileSplitter.cpp
   これは、アプリケーション クラス CFileSplitterApp を含むメイン アプリケー
   ション ソース ファイルです。
...
res\FileSplitter.ico
   これは、アプリケーションのアイコンとして使用されるアイコンファイルです。この
   アイコンはメイン リソース ファイル FileSplitter.rc に含まれていま
   す。

res\FileSplitter.rc2
...
FileSplitterDlg.h, FileSplitterDlg.cpp - ダイアログ
   これらのファイルは CFileSplitterDlg クラスを含みます。このクラスはアプ
   リケーションのメイン ダイアログの動作を定義します。ダイアログ テンプレートは
   Microsoft Visual C++ で編集可能な FileSplitter.rc に含まれます。
...
StdAfx.h, StdAfx.cpp
   ...
   FileSplitter.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
